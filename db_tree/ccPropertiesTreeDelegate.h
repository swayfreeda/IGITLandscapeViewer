...
public:
	...
	virtual QWidget *createEditor(QWidget *parent, const QStyleOptionViewItem &option, const QModelIndex &index) const; //创建编辑
	//virtual bool editorEvent(QEvent* event, QAbstractItemModel* model, const QStyleOptionViewItem& option, const QModelIndex& index);
	virtual void updateEditorGeometry(QWidget* editor, const QStyleOptionViewItem& option, const QModelIndex& index) const; //升级编辑几何
	virtual void setEditorData(QWidget *editor, const QModelIndex &index) const; //设置编辑数据
	virtual void unbind();
