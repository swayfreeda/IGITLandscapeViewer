...
#define CC_HIERARCH_BIT					0x00000000000001	//Hierarchical object//分层物体
#define CC_LEAF_BIT						0x00000000000002	//Tree leaf (no children)// 叶子节点
#define CC_GROUP_BIT					0x00000000000004	//Group (no data, aggregation only)
#define CC_PRIMITIVE_BIT				0x00000000000008	//Primitive (sphere, plane, torus, cylinder, etc.)//基元
#define CC_ARRAY_BIT					0x00000000000010	//Array //矩阵
#define CC_LABEL_BIT					0x00000000000020	//2D label //二维标签
#define CC_VIEWPORT_BIT					0x00000000000040	//2D viewport // 二维视角
#define CC_CUSTOM_BIT					0x00000000000080	//For custom (plugin defined) objects //插件
#define CC_CLOUD_BIT					0x00000000000100	//Point Cloud//点云
#define CC_MESH_BIT						0x00000000000200	//Mesh//网格
#define CC_OCTREE_BIT					0x00000000000400	//Octree//八叉树
#define CC_POLYLINE_BIT					0x00000000000800	//Polyline//折线
#define CC_IMAGE_BIT					0x00000000001000	//Picture//图像
#define CC_SENSOR_BIT					0x00000000002000	//Sensor def.//传感器
#define CC_PLANE_BIT					0x00000000004000	//Plane (primitive) //平面
#define CC_SPHERE_BIT					0x00000000008000	//Sphere (primitive) //球体
#define CC_TORUS_BIT					0x00000000010000	//Torus (primitive) //圆环面
#define CC_CYLINDER_BIT					0x00000000020000	//Cylinder (primitive)//圆柱
#define CC_CONE_BIT						0x00000000040000	//Cone (primitive)//圆锥
#define CC_BOX_BIT						0x00000000080000	//Box (primitive)//
#define CC_DISH_BIT						0x00000000100000	//Dish (primitive)//圆盘
...
#define CC_MATERIAL_BIT					0x00000001000000	//Material//材料
...
#define CC_RGB_COLOR_BIT				0x00000010000000	//Color (R,G,B)//颜色
#define CC_NORMAL_BIT					0x00000020000000	//Normal (Nx,Ny,Nz)//法向量
#define CC_COMPRESSED_NORMAL_BIT		0x00000040000000	//Compressed normal (index)
#define CC_TEX_COORDS_BIT				0x00000080000000	//Texture coordinates (u,v)//纹理坐标
#define CC_CAMERA_BIT					0x00000100000080	//For camera sensors (projective sensors)//相机传感器
#define CC_QUADRIC_BIT					0x00000200000080	//Quadric (primitive)// 二次曲线
...
class QCC_DB_LIB_API ccObject : public ccSerializableObject
	//ccSerializableObject主要提供从二进制数据流中读取和存储数据功能
{
public:
