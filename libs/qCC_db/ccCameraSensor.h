...
public: //general
	...
	**/
	...
	//! Constructor with given intrinsic parameters (and optional uncertainty parameters) //构造函数
	ccCameraSensor(const IntrinsicParameters& iParams);

	//! Destructor //析构函数
	virtual ~ccCameraSensor();

	//inherited from ccHObject //集成函数
...
public: //getters and setters
	...
	**/
	bool getProjectionMatrix(ccGLMatrix& matrix); //得到投影矩阵（内参矩阵)
...
public: //frustrum display
	...
	inline void drawFrustrum(bool state) { m_frustrumInfos.drawFrustum = state; } //绘制视锥体
	...
	//! Sets whether the frustum planes should be displayed or not//视锥体平面??
...
protected:
	...
	**/
	...
	IntrinsicParameters m_intrinsicParams; //内参数

	//! Lens distortion parameters 
	LensDistortionParameters::Shared m_distortionParams; //径向畸变参数

	//! Frustrum information structure
	/** Used to draw it properly.
	**/
	FrustumInformation m_frustrumInfos;// 视锥体

	//! Intrinsic parameters matrix
	ccGLMatrix m_projectionMatrix;  //内参数矩阵
